...
public class DeptSalesReport extends DefaultHandler {
    private static final String CLASS_NAME = DeptSalesReport.class.getName();
    ...
    public static void main(String args[]) {
        ...
        DeptSalesReport handler = new DeptSalesReport();
